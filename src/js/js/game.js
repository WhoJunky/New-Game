...
const logoH1 = document.querySelector(".logo"); //1
...
const checkLetter = (letter) => {
  ...
  if (!word.includes(inputLetter)) {
    ...
    hangmanImg.src = `images/hg-${10 - triesLeft}.png`; //поставим обратные ковычки, для передачи динамического чиса
  }
  if (triesLeft === 0) {
    stopGame("lose");
  } else {
    //буква в слове есть
    const wordArray = Array.from(word); //Array - создание массива из строки
...
export const startGame = () => {
  ...
  gameDiv.appendChild(keyboradDiv);
